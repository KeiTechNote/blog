...
### SSI 생태계
![SSI 생태계](roles_information_flow.png)
...
```
오늘 오전 09:00. ABC 산부인과에서 아내가 첫째 아이를 출산했습니다. 
너무 기쁜 나머지 출산과 동시에 산부인과에서 출생증명서를 발급받고 전자가족관계등록 시스템을 통해 출생신고를 마쳤습니다. 
```

위 이야기에서는 holder 는 '아빠' 또는 '아이' 입니다. issuer 는 'ABC 산부인과', verifier 는 '전자가족관계등록시스템(정부)' 가 됩니다. 
